...
public class UiModeManager {
    ...
    /** @hide */
    @IntDef({MODE_NIGHT_AUTO, MODE_NIGHT_NO, MODE_NIGHT_YES, MODE_NIGHT_ATOMIZED})
     ...
     * always run in night mode.
     */
    public static final int MODE_NIGHT_ATOMIZED = Configuration.UI_MODE_NIGHT_ATOMIZED >> 4;
